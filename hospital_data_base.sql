...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2024 at 10:27 PM
...
CREATE TABLE `consultation` (
  ...
  `Date et heure` date DEFAULT NULL,
  `Diagnostic (examens physique)` text DEFAULT NULL,
  `Prescription (médicaments, examens...)` text DEFAULT NULL
...
CREATE TABLE `examen / test médical` (
  ...
  `Type d'examen (analyse sanguine, radiographie, échographie....)` text DEFAULT NULL,
  `Date` date DEFAULT NULL,
  `Résultats` text DEFAULT NULL,
  `ID_Patient` int(11) DEFAULT NULL,
  `ID_Médecin` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `hospitalisation` (
  ...
  `ID_Patient` int(11) DEFAULT NULL,
  `Date d'admission` date DEFAULT NULL,
...
CREATE TABLE `intervention chirurgicale` (
  ...
  `ID_Patient` int(11) DEFAULT NULL,
  `ID_Médecin` int(11) DEFAULT NULL,
  `Date Intervention` date DEFAULT NULL,
  `Type Intervention (chirurgie mineure, majeure, laparoscopie....)` varchar(255) DEFAULT NULL,
  `Durée Intervention` varchar(255) DEFAULT NULL,
  `État Intervention : Statut de l'intervention` varchar(255) DEFAULT NULL,
  `Anesthésie :Type d'anesthésie utilisée(générale,locale,régional)` varchar(255) DEFAULT NULL,
  `Salle Opératoire` varchar(255) DEFAULT NULL,
  `ID_Personnel` int(11) DEFAULT NULL,
  `Délai_Récupération` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `médicament` (
  ...
  `Forme (comprimé, injection...)` varchar(255) DEFAULT NULL,
  `Dosage` text DEFAULT NULL,
  `Eets secondaires [` text DEFAULT NULL,
  `Description` text DEFAULT NULL,
  `Date de péremption` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `patient` (
  ...
  `Groupe sanguin` char(5) DEFAULT NULL,
  `Antésidants (personnel ou familiale)` text DEFAULT NULL,
  `cartes de soins ( eu ou non )` tinyint(1) DEFAULT NULL,
  `Date d'admission` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `personnel (inrmiers, techniciens...)` (
  ...
  `Nom` varchar(50) DEFAULT NULL,
  `Prénom` varchar(50) DEFAULT NULL,
  `Poste (infirmier, technicien...)` varchar(50) DEFAULT NULL,
  `Service d'aectation` varchar(50) DEFAULT NULL,
  `Téléphone` varchar(255) DEFAULT NULL,
...
CREATE TABLE `traitement` (
  ...
  `ID_Patient` int(11) DEFAULT NULL,
  `Nom du médicament` varchar(255) DEFAULT NULL,
  `Dosage` text DEFAULT NULL,
  `Durée` varchar(255) DEFAULT NULL,
  `Date de prescription` date DEFAULT NULL,
  `ID_Médecin` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
